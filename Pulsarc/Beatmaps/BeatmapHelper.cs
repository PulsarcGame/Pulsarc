...
namespace Pulsarc.Beatmaps
{
    static class BeatmapHelper
    {
        ...
        public static Beatmap Load(string path, string fileName)
        {
        ...
        /// <param name="filePath">The filepath this Beatmap Should be saved to.</param>
        public static void Save(Beatmap beatmap, string filePath)
        {
        ...
        private static void WriteProperty(StreamWriter file, Beatmap beatmap, string property)
        {
            try
            {
        ...
        /// <returns></returns>
        public static bool IsColumn(Arc arc, int column)
        {
        ...
        private static Event MakeEvent(string line, EventType type)
        {
            return type switch
            {
                EventType.Zoom => new ZoomEvent(line),
                _ => null
            };
        }
    }
