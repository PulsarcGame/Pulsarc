...
{
    public abstract class EditorEngineViewOld : ScreenView
    {
        private Background background;

        private EditorEngineOld GetEditorEngine() { return (EditorEngineOld)Screen; }

        public EditorEngineViewOld(Screen screen) : base(screen) { }
